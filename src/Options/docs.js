 ...
 * @property {Boolean} keepUnknownIndexes Keep indexes that are not defined in the schema and are present in the database. Set this to `true` if you are adding indexes manually so that they won't be dropped when running schema migration.
 ...
 * @property {LiveQuerySubscriptionHandlers} subscriptionHandlers Class-scoped handlers for LiveQuery subscription lifecycle events. This option can only be configured programmatically.
