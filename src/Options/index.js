...
export interface SchemaOptions {
  ...
  :DEFAULT: false */
  lockSchemas: ?boolean;
  /* Keep indexes that are not defined in the schema and are present in the database. Set this to `true` if you are adding indexes manually so that they won't be dropped when running schema migration.
  :DEFAULT: false */
